                            ...
                            <CardContent className="space-y-3 sm:space-y-4 pt-3 sm:pt-4 px-4 sm:px-6">
                                ...
                                {formData.featuredImage ? (
                                    <div className="space-y-2">
                                        ...
                                        {!formData.featuredImage.match(/\.(jpg|jpeg|png|webp|gif|bmp|svg)(\?.*)?$/i) && (
                                            <p className="text-xs text-yellow-600 bg-yellow-50 p-2 rounded">
                                                ⚠️ This doesn't look like a direct image URL. Make sure it ends with .jpg, .png, etc.
                                            </p>
                                        )}
                                    </div>
                                ) : (
                                    <div className="aspect-video bg-gray-100 rounded-lg border border-gray-200 border-dashed flex items-center justify-center">
                                        <div className="text-center text-gray-500">
                                            <Image className="h-6 w-6 sm:h-8 sm:w-8 mx-auto mb-1 sm:mb-2 opacity-50" />
                                            <p className="text-xs sm:text-sm">No featured image</p>
                                        </div>
                                    </div>
                                )}
                            </CardContent>
                                ...
                                <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs sm:text-sm text-blue-700">
                                            Review your post details before updating
                                        </p>
                                    </div>
                                </div>
