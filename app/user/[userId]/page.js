  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Button 
              variant="ghost" 
              asChild 
              className="group -ml-2 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-200"
            >
              <Link href="/" className="flex items-center gap-2">
                <ArrowLeft className="h-4 w-4 text-slate-600 dark:text-slate-400 group-hover:text-slate-900 dark:group-hover:text-white transition-colors group-hover:-translate-x-1 transition-transform duration-200" />
                <span className="text-sm font-medium text-slate-700 dark:text-slate-300 group-hover:text-slate-900 dark:group-hover:text-white">Back to Home</span>
              </Link>
            </Button>
            
            <div className="flex items-center gap-2">
              <Button variant="ghost" size="sm" className="hidden sm:flex items-center gap-2 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300">
      ...
      <section className="relative pt-16 pb-0 overflow-hidden">
        {/* Cover Background */}
        <div className="absolute inset-0 h-80 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 dark:from-blue-900 dark:via-indigo-900 dark:to-purple-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center pt-24 pb-8">
            <Avatar className="h-32 w-32 sm:h-40 sm:w-40 ring-8 ring-white dark:ring-slate-900 shadow-sm mb-6 transition-transform hover:scale-105 duration-300">
            ...
            <div className="text-center space-y-4 max-w-3xl">
              <div>
                <h1 className="text-4xl sm:text-5xl font-bold text-black capitalize mb-3 tracking-tight">
                  {user.username}
                </h1>
                <div className="flex flex-wrap gap-2 justify-center mb-4">
                  <Badge className="bg-white/20 text-black border-white/30 backdrop-blur-sm px-4 py-1.5 text-sm font-medium hover:bg-white/30">
              ...
              {user.bio && (
                <p className="text-lg sm:text-xl text-black/90 leading-relaxed font-light max-w-2xl mx-auto">
                  {user.bio}
                </p>
              )}
              ...
              <div className="flex flex-wrap gap-3 justify-center pt-4">
                {/* <Button className="bg-white text-slate-900 hover:bg-slate-100 shadow-sm font-semibold px-6">
                  <UserPlus className="h-4 w-4 mr-2" />
                  Follow
                </Button> */}
                <Button variant="outline" className="bg-black/10 text-gray border-white/30 hover:bg-gray/20 backdrop-blur-sm font-medium px-6 hover:text-gray-800">
              ...
              {/* User Meta */}
              <div className="flex flex-wrap justify-center gap-6 text-sm text-black/90 pt-4">
                {user.email && (
                  <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 pb-8">
            <Card className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-sm transition-all duration-300 hover:-translate-y-1">
          ...
          {posts.length > 0 ? (
              ...
              <Card className="border-slate-200 dark:border-slate-800 shadow-sm bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-800">
                <CardContent className="p-8">
                  <div className="text-center space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 py-6 border-t border-b border-slate-200 dark:border-slate-700">
                      <div>
                    ...
                    <Button asChild variant="outline" className="mt-4 text-slate-700 dark:text-slate-300 border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800">
                      <Link href="/">
            ...
            <Card className="border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden bg-white dark:bg-slate-900">
              <CardContent className="p-16 text-center">
                <div className="w-24 h-24 bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-700 rounded-full flex items-center justify-center mx-auto mb-8 shadow-sm">
                  <FileText className="h-12 w-12 text-slate-400 dark:text-slate-500" />
                </div>
                <CardTitle className="text-3xl mb-4 text-slate-900 dark:text-white font-bold">
                  No Articles Yet
                </CardTitle>
                <CardDescription className="text-lg text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
